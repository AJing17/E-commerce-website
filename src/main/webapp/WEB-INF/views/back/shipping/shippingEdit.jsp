                                                ...
                                                <tbody class="align-middle">
                                                    <tr>
                                                        ...
                                                        <td class="align-middle"  style="width:20em;" >
                                                            <form:input path="shippingState" id="state" type="hidden"
                                                                value="${UpdateShipping.shippingState}" style="width:20em;" />
                                                             <input type="radio" name="state" id="new" value=""><span id="newState"></span>
                                                             <input class="ml-2" type="radio" name="state" id="now" value="${UpdateShipping.shippingState}" checked/>
                                                             <span id="nowState">${UpdateShipping.shippingState}</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
