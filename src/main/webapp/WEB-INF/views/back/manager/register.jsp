    ...
    <div class="container" id="login-inside">
        ...
        <form:form action="${pageContext.request.contextPath}/Back/manager/register" method="post"
            ...
            <div class="col d-flex" style="justify-content:center ">
                <span  class="btn text-dark add" id="testf">測試失敗新增(重複帳號)</span>
                <span  class="btn text-dark add" id="test">測試成功新增</span>
            </div>
                ...
                <div class="row">
                    <div class="col d-flex" style="justify-content:center ;">
                        <input type="submit" id="btn_create_acc" class="btn-primary text-dark add" value="新增管理者">
                    </div>
                </div>
            <div class="col d-flex" style="justify-content:center ">
                <a href="${pageContext.request.contextPath}/Back/manager" class="btn text-secondary border add " >回到管理者頁面</a>
            </div>
...
<script>
    ...
    $('#test').click(function (){
       $('#name').val("頑皮老闆");
       $('#phone').val("0909123788");
       $('#email').val("qwe123788@gmail.com");
       $('#password').val("qwe123788");
    });
