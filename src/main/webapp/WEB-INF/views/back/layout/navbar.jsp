...
<div class="col-lg-3 d-none d-lg-block pt-3">
                <div class="container-fluid">
                    <ul class="p-0 menu border-left border-right">
                        ...
                        <li>
                            <a
                                    class="btn shadow-none d-flex border-bottom align-items-center justify-content-between bg-primary text-white w-100">管理者管理</a>
                            <ul class="inmenu">
                                <li><a href="${contextRoot}/Back/manager"
                                       class="btn d-flex border-bottom align-items-center justify-content-between text-black w-100">管理者設定</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
