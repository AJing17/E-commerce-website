            ...
            <body>
                    ...
                    <div class="row border-top px-xl-3">
                        ...
                        <div class="col-lg-8 pt-3">
                            <div class="container-fluid pt-1">
                                ...
                                <div class="ml-1">
                                        <form:form action="${contextRoot}/back/updatePayment" method="post"
                                                    ...
                                                    <tr>
                                                        ...
                                                        ${UpdatePayment.paymentId}
                                                            <form:input path="paymentId" type="hidden"
                                                                onfocus="this.blur();"
                                                                value="${UpdatePayment.paymentId}" />
                                                        </td>
                                                        <td class="align-middle" style="width:30em;">
                                                            <form:input path="paymentWay" type="text" id="way"
                                                                value="${UpdatePayment.paymentWay}" style="width:20em;"/>
                                                        </td>
                                                        <td class="align-middle" style="width:20em;">
                                                            <form:input path="paymentState" type="hidden" id="state"
                                                                value="${UpdatePayment.paymentState}" />
                                                              <input type="radio" name="state" id="new" value=""><span id="newState"></span>
                                                             <input class="ml-2" type="radio" name="state" id="now" value="${UpdatePayment.paymentState}" checked/>
                                                             <span id="nowState">${UpdatePayment.paymentState}</span>   
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            <button type="submit" class="btn btn-primary mb-3" id="update">送出修改</button>
                                            <a href="${contextRoot}/back/payment"
                                                class="text-primary font-weight-medium ml-2">返回查詢</a>
                ...
                <script>
                    ...
                    $('#update').click(function () {
                        ...
                        if (yes) {
                            if (wayText == "不可為空" || stateText == "不可為空") {
                                window.event.returnValue = false;
                                alert("不可為空");
                            } else if (wayText == "輸入錯誤" || stateText == "輸入錯誤") {
                                window.event.returnValue = false;
                                alert("輸入錯誤")
                            } else {
                                alert("輸入正確,更新一筆資料")
