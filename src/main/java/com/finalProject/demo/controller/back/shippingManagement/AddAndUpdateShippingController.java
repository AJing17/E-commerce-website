...
public class AddAndUpdateShippingController {
	...
	public String addShipping(@ModelAttribute(name="Shipping") Shipping shipping) {
		//設定新的shipping
		shipping.setShippingWay(shipping.getShippingWay());
		shipping.setShippingFee(shipping.getShippingFee());
	...
	public String UpdateShipping(@ModelAttribute(name="UpdateShipping") Shipping shipping,Model model) {
		Shipping newShipping = new Shipping();
		newShipping.setShippingId(shipping.getShippingId());
		newShipping.setShippingWay(shipping.getShippingWay());
		newShipping.setShippingFee(shipping.getShippingFee());
		newShipping.setShippingState(shipping.getShippingState());
